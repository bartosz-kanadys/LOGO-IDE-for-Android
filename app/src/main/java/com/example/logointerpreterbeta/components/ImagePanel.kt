...
fun ImagePanel() {
    ...
    Box(
        ...
        Image(
            bitmap = MyLogoVisitor.image.apply { eraseColor(MaterialTheme.colorScheme.surface.toArgb()) }.asImageBitmap(),
...
@Composable
fun ImageButton(icon: ImageVector, tint: Color = MaterialTheme.colorScheme.onSurface, @SuppressLint("ModifierParameter") modifier: Modifier = Modifier, onClick: () -> Unit) {
    IconButton(
        onClick = { onClick() },
