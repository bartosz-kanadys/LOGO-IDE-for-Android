...
public class logoParser extends Parser {
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'FILL'", "'setpc'", "'SETPC'", "'setpencolor'", "'SETPENCOLOR'", "'setps'", 
			"'SETPS'", "'arc'", "'ARC'", "'repeat'", "'REPEAT'", "'['", "']'", "'if'", 
			"'IF'", "'<'", "'>'", "'='", "'<='", "'>='", "'<>'", "'make'", "'MAKE'", 
		...
		try {
			...
			do {
				...
				case 1:
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
					if ((((_la) & ~0x3f) == 0 && ((1L << _la) & -33915947987239798L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 165476499980287L) != 0)) {
						{
						setState(92);
						line();
						}
		...
		try {
			...
			case STRING:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -35604797847503744L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 24739011624959L) != 0) );
				setState(111);
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (_la==COMMENT) {
		...
		try {
			...
			case T__0:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & -33915947987239798L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 446951476690943L) != 0) );
				setState(176);
				match(T__1);
				}
				break;
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & -35604797847503744L) != 0) || ((((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 869163941756927L) != 0)) {
				{
				{
				setState(300);
				_errHandler.sync(this);
